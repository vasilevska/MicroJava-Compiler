...
public class ConstructorDecls extends ConstructorDeclList {

    private ConstructorDeclList ConstructorDeclList;
    private ConstructorDecl ConstructorDecl;

    public ConstructorDecls (ConstructorDeclList ConstructorDeclList, ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstructorDecls(\n");
